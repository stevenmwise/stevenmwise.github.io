...
I teach courses in PDE, analysis, applied mathematics, and numerical analysis. With Abner Salgado, I wrote a graduate-level textbook entitled [Classical Numerical Analysis: A Comprehensive Course](https://doi.org/10.1017/9781108942607), published by Cambridge University Press in 2023. You can check it out on Amazon or on Cambridge Core. My second book, [Multigrid Methods: Axiomatic Convergence Theory for Linear and Weakly Nonlinear Problems](https://doi.org/10.1515/9783111354880), focusing on basic theory and implementation in Matlab and published by De Gruyter (2026), is now available on Amazon. This book is coauthored by Abner Salgado and Calvin Wong. Supplementary materials for both books can be found on my GitHub repo, [stevenmwise](https://github.com/stevenmwise).
