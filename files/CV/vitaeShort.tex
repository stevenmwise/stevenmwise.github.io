...
{\LARGE\bf Broad Research Impact}
    \begin{description}
    \item
\textbf{About 130 publications:} textbooks, journal articles, and technical reports.
    \item
...
\url{https://recognition.webofscience.com/awards/highly-cited/2022/}
   	\item
\textbf{Google Scholar Citation Metrics:} over 11100 citations, h-index 55, as of May, 2026
    \end{description}
    
    \smallskip
	
{\LARGE\bf Interdisciplinary  Research Interests}
    \begin{description}
    \item
...
{\LARGE\bf Current External Funding}
    \begin{description}
...
T.~Luong, T.~Mengesha and \textbf{S.M.~Wise}, {\sl Asymptotic Analysis and Perturbation Theory: Matched Asymptotic, Multiple Scale, and Homogenization Methods}, (in preparation, contract pending, 70\% complete), approx.~400 pages.
    ...
    \item
\textbf{S.M.~Wise}, {\sl Non-Equilibrium Thermodynamics}, (in preparation, 20\% complete), approx.~200 pages.
    \end{enumerate}


{\LARGE\bf  Journal Publications Since 2022}
