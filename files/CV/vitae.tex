...
\url{https://doi.org/10.1017/9781108942607}
    \item
A.J.~Salgado, \textbf{S.M.~Wise}, and M.H.~Wong, {\sl An Introduction to Multigrid Methods: A Mostly Matrix-Based Approach}, De Gruyter (under contract, 90\% complete), approx.~400 pages.
	\item
T.~Luong, T.~Mengesha and \textbf{S.M.~Wise}, {\sl Essential Asymptotic Analysis and Perturbation Theory}, De Gruyter (in contract negotiations, 50\% complete), approx.~400 pages.
    \end{enumerate}
...
\url{https://doi.org/10.4208/ijnam2025-1031}
	...
	\item
Y.~Guo, C.~Wang, \textbf{S.M.~Wise}, and Z.~Zhang, {\sl A Uniquely Solvable and Positivity-Preserving Finite Difference Scheme for the Flory-Huggins-Cahn-Hilliard Equation with Dynamical Boundary Condition}, J.~Comput.~Appl.~Math.~(in review).
	\\
