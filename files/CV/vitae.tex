...
\url{https://doi.org/10.1017/9781108942607}
    \item
A.J.~Salgado, \textbf{S.M.~Wise}, and M.H.~Wong, {\sl An Introduction to Multigrid Methods: A Mostly Matrix-Based Approach}, De Gruyter (under contract, 90\% complete), approx.~300 pages.
	\item
...
2019 SIAM-SEAS Conference, with C.~Webster (UTK, Lead), G.~Zhang (ORNL), September 20, 21, 22, 2019, Knoxville, TN.
	\item
2025 SIAM-SEAS Conference, with V.~Maroulas (UTK, Lead), G.~Zhang (ORNL), March 2024, Knoxville, TN.
	\end{description}
    \end{description}
    \end{description}
