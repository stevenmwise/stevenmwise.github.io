...
\url{https://recognition.webofscience.com/awards/highly-cited/2022/}
   	\item
\textbf{Google Scholar Citation Metrics:} over 10500 citations, h-index 52, as of January, 2025
    \end{description}
...
Charlotte Beckford, Math UTK, PhD 2026 (expected).
	\item
Daniel Bond (co-advisor, Cory Hauck), Math UTK, PhD 2027 (expected).
	\item
Sam Gruber, Math UTK, PhD 2027 (expected).
	\item
...
Ben Plumridge (primary advisor, Cory Hauck), Math UTK, PhD 2025 (expected).
	\item
Suleman Shahid (co-advisor, Abner Salgado), Math UTK, PhD 2027 (expected).
	\item
