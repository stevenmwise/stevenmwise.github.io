...
\url{https://recognition.webofscience.com/awards/highly-cited/2022/}
   	\item
\textbf{Google Scholar Citation Metrics:} over 11100 citations, h-index 53, as of September, 2025
    \end{description}
...
\textbf{Nonlinear PDE:}~Existence, uniqueness, and regularity of solutions for nonlinear parabolic-hyperbolic PDE and related integro-partial differential equations (IPDE), especially for models related to phenomena described above.
	\item
\textbf{Nonlinear Analysis:}~$\Gamma$ convergence and asymptotic analyses for diffuse interface and diffuse domain problems.
    \end{description}
...
Creative Achievement Award:} University of Tennessee, Spring 2025,  \$3000.
...
{\LARGE\bf Supplementary Support for PhD Students}\footnote{These awards are listed because the PI helped in the preparation of the application proposals and supervised the work. The awards went directly to the students, not to the PI, just to be clear.}
    ...
    \begin{description}  
	\item
Charlotte Beckford, University of Tennessee-Oak Ridge Innovation Institute's (UTORII's) Science Alliance Graduate Advancement, Training and Education (GATE) Fellowship, \$37,000 (approx.) per year, plus tuition, 8/2024 -- 7/2026. Topic:~``Thermodynamically Consistent Models of Polymeric Battery Systems." Advisors R.~Kumar (ORNL) and \textbf{S.M.~Wise} (UTK).   
    \item
...
John Cummings, United States Department of Energy Office of Science Graduate Student Research (SCGSR) Program Award/Fellowship, \$36,000 (approx.) plus tuition, 1/15 -- 1/16. PhD 2017.  Topic:~``Simulating Polymer-Solvent Mixtures for Organic-Photovoltaic Devices." Co-advisors R.~Kumar (ORNL), \textbf{S.M.~Wise} (UTK).
	\item
Sam Gruber, University of Tennessee-Oak Ridge Innovation Institute's (UTORII's) Science Alliance Graduate Advancement, Training and Education (GATE) Fellowship, \$37,000 (approx.) per year plus tuition, 8/2025 -- 7/2027. Topic:~``Phase Transformations in SrCoOx Materials for Neuromorphic Computing Architectures." Advisors V.~Starchencko (ORNL), P.~Ganesh (ORNL), and \textbf{S.M.~Wise} (UTK).
	\end{description}
...
\url{https://doi.org/10.1017/9781108942607}
    \item
A.J.~Salgado, \textbf{S.M.~Wise}, and Calvin Wong, {\sl Multigrid Methods: Axiomatic Convergence Theory for Linear and Weakly Nonlinear Problems}, De Gruyter (2026) approx.~500 pages.
	\\
\url{https://doi.org/10.1515/9783111354880}

	\item
T.~Luong, T.~Mengesha and \textbf{S.M.~Wise}, {\sl Asymptotic Analysis and Perturbation Theory: Matched Asymptotic, Multiple Scale, and Homogenization Methods}, (in preparation, contract pending, 70\% complete), approx.~400 pages.

    \item
\textbf{S.M.~Wise}, and Calvin Wong, {\sl Non-Equilibrium Thermodynamics}, (in preparation, 20\% complete), approx.~200 pages.
    \end{enumerate}
...
Flow}, J.~Fluid.~Mech.~(in review).
	\\
\url{https://doi.org/10.48550/arXiv.2509.08295}
...
\textbf{M.S. Examination Committees}, UTK, Robert Burnham, Summer 2011; Aaron Craig, Fall 2014; Steve Fassino, Summer 2013; Stephen E. Galloway, Spring 2017 (primary advisor); Casey Hufford, Summer 2011; Dragos Ilas, Fall 2013; Kai Kang, Spring 2012 (primary advisor); Manda Saylor, Spring 2010; Jillian Trask, Summer 2014.
	...
	\item
\textbf{Task Force on Reduced Teach Loads}, UTK, Spring 2025 (chair).

	\item
\textbf{Ph.D. Examination Committees}, UTK, 3-5 per year, ongoing.
	\item
...
\textbf{Tenure and Promotion (T\&P) and Promotion (P) Committees}, UTK, academic year 2016-17 (A.~Salgado, T\&P), 2017-18 (T.~Mengesha, T\&P), 2020-21 (A.~Salgado, P), 2021-22 (T.~Mengesha, P), 2021-22 (O.~Prosper, T\&P).
	...
	\item
\textbf{Graduate Student Advising and Mentoring Committee}, UTK, 2022-23 (chair), 2023-24 (chair), 2024-25 (chair), 2025-26 (chair).
...
\textbf{Conference Co-Organizer} 
	\begin{description}
	\item 
Southeastern-Atlantic Regional Conference on Differential Equations (SEARCDE), with S.~Lenhart (UTK, Lead Organizer) and T.~Phan (UTK), September 21, 22, 2013, Knoxville, TN.
	\item
2017 Barrett Lectures: Mathematical Foundations of Data Sciences, with V.~Maroulas (UTK, Lead Organizer), C.~Webster (UTK), J. Rosinski (UTK), May 1, 2, 3, 2017, Knoxville, TN.
	\item
2019 SIAM-SEAS Conference, with C.~Webster (UTK, Lead Organizer), G.~Zhang (ORNL), September 20, 21, 22, 2019, Knoxville, TN.
	\item
2025 SIAM-SEAS Conference, with V.~Maroulas (UTK, Lead Organizer) and several coorganizers, March 2025, Knoxville, TN.
	\end{description}
    \end{description}
    \end{description}
...
{\LARGE\bf  Graduate Students}
	\begin{description}
	\item
{\Large\bf Former (alphabetical by Last Name)}
	\begin{enumerate}
	\item
Andreas Aristotelous, Math UTK, PhD 2011.  Thesis:~``Adaptive Discontinuous Galerkin Finite Element Methods for a Diffuse Interface Model of Biological Growth." (O.~Karakashian, UTK, was the primary advisor.) First position: postdoc at Duke University and SAMSI.
	\item
Kylie Berry, Math UTK, PhD 2019.  Topic:~``Energy-Based Blending Models in Peri-dynamics." (T.~Mengesha, UTK, was the co-advisor, and P.~Seleson was the technical point of contact at ORNL for this project.) First position: Assistant Professor of Mathematics at Dalton State College, Dalton, GA.
	\item
Craig Collins, Math UTK, PhD 2015.  Thesis:~``Domain Decomposition Methods for Discontinuous Galerkin Approximations of Elliptic Problems." (O.~Karakashian, UTK, was the primary advisor.) First position: Assistant Professor of Mathematics at Murray State University, Murray, KY.
	\item
John Cummings, Math UTK, PhD 2017.  Topic:~``Simulating Block Polymer-Solvent Mixtures for Organic-Photovoltaic Devices."  (R.~Kumar was the technical point of contact at ORNL for this project.) First position: Visiting assistant professor, Berry College, Rome, GA.
	\item
Amanda Diegel, Math UTK, PhD May 2015.  Thesis:~``Numerical Analysis of Convex Splitting Schemes for Cahn-Hilliard and Coupled Cahn-Hilliard-Fluid-Flow Equations." First position: Postdoctoral researcher, Mathematics Department, Louisiana State University, Baton Rouge, LA.
	\item
...
Stephen Galloway, Math UTK, MS 2017.  Project:~``Numerical Simulation of Solidification with Strong Interface Anisotropy." Continued in PhD program at UTK.
	\item
Stephen Galloway, Math UTK, PhD 2020.  Thesis:~``Graphene Formation using the PFC Model with a Vapor Phase." First position: Assistant Professor, Mathematics Department, St.~Andrews University, Laurinburg, NC.
	\item
Zhen Guan, Math UTK, PhD August 2012.  Thesis:~``Numerical Analysis of First and Second Order Unconditionally Energy Stable Schemes for Nonlocal Cahn-Hilliard and Allen-Cahn Equations." First position: Visiting Assistant Professor, Mathematics Department, University of California, Irvine, CA.
	\item
Evan Habbershaw, Math UTK, PhD 2025. Project: ``Numerical Methods for Multi-Species BGK Models." (C.~Hauck was the technical point of contact at ORNL for this project.) First position: Visiting Assistant Professor, Mathematics Department, Pennsylvania State University, State College, PA.
	\item
Ben Plumridge, Math UTK, PhD 2025. Project: ``Neural Network-Based Adaptive Filtering of the Spherical Harmonic Method in Radiation Transport." (Cory Hauck, ORNL, was the primary advisor.) 
...
Kai Kang, Math UTK, MS May 2012.  Project:~``A Second-Order Accurate Energy Stable Scheme for the Cahn-Hilliard-Hele-Shaw System of Equations: Application to Tumor Growth." Went on to complete PhD at UTK, 2017.
	...
	\item
Jea-Hyun Park, Math UTK, PhD 2021.  Thesis:~``Preconditioned Nesterov's Accelerated Gradient Descent Method and its Applications for Nonlinear PDE." (A.~Salgado, UTK, was the co-advisor.) First position: Visiting Assistant Professor,  Mathematics Department, University of California, Santa Barbara, CA. 
	\end{enumerate}
	\item
{\Large\bf Current (alphabetical by last name)}
	\begin{enumerate}
	\item
George Babus, Math UTK, PhD 2027 (expected). Project: ``Mathematics of Quantum Computing." (Gonzalo Alvarez, of the Computational Chemistry and Nanomaterials Sciences Group, is the technical point of contact at ORNL for this project.) My UTK advising percentage: 25\%.	
	\item
Charlotte Beckford, Math UTK, PhD 2026 (expected). Project: ``Thermodynamically Consistent Models of Polymer Batteries." (R.~Kumar is the technical point of contact at ORNL for this project.) My UTK advising percentage: 100\%.
	\item
Sam Gruber, Math UTK, PhD 2027 (expected).  Project:~``Phase Transformations in SrCoOx Materials for Neuromorphic Computing Architectures." (V.~Starchencko and P.~Ganesh are the technical points of contact at ORNL for this project.) My UTK advising percentage: 100\%.
	\item
Jack Haight, Math UTK, PhD 2027 (expected). Project: ``Numerical Methods for Kinetic Equations." (C.~Hauck is the technical point of contact at ORNL for this project.) My UTK advising percentage: 100\%.
	\item
Suleman Shahid, Math UTK, PhD 2027 (expected). Project: TBD. (Abner Salgado, UTK, is the co-advisor.) My UTK advising percentage: 50\%.
	\item
Calvin Wong, Math UTK, PhD 2026 (expected). Project: ``Numerical Methods for and Asymptotic Analyses of Diffuse Domain Problems." (C.~Hauck is the technical point of contact at ORNL for a companion project.) My UTK advising percentage: 100\%.
	\end{enumerate}
...
{\LARGE\bf  Postdoctoral Researchers}
	\begin{description}
	\item
{\Large\bf Former}
	\begin{description}
	\item
Toai Luong, 2022-2025, PhD from University of Alabama. First position after UTK: Visiting Assistant Professor, Virginia Commonwealth University, Richmond, VA.
	\end{description}
