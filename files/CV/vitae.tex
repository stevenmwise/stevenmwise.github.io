...
\url{https://doi.org/10.1017/9781108942607}
    \item
A.J.~Salgado and \textbf{S.M.~Wise}, {\sl An Introduction to Multigrid Methods: A Mostly Matrix-Based Approach}, De Gruyter (under contract, 90\% complete), approx.~300 pages.
	\item
T.~Mengesha and \textbf{S.M.~Wise}, {\sl Essential Asymptotic Analysis and Perturbation Theory}, De Gruyter (in contract negotiations, 50\% complete), approx.~400 pages.
    \end{enumerate}
