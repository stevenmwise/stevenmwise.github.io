...
\url{https://trace.tennessee.edu/utk_mathpubs/11/}
	...
	\item
Y.~Sun, J.~Wu, M.~Jiang, \textbf{S.M.~Wise}, and Z.~Guo, {\sl A Thermodynamically Consistent Phase-Field Model and an Entropy Stable Numerical Method for Simulating Two-Phase Flows with Thermocapillary Effects}, Appl.~Numer.~Math.~(in press).
	\\
...
Ben Plumridge (primary advisor, Cory Hauck), Math UTK, PhD 2025 (expected).
	\item
Calvin Wong (primary advisor, Cory Hauck), Math UTK, MS 2024 (expected).
	\end{description}
