...
\url{swise1@utk.edu} \ $\diamond$ \ \url{https://faculty.utk.edu/Steven.Wise}
	\\
\url{https://stevenmwise.github.io} \ $\diamond$ \   \url{https://github.com/stevenmwise}
	\\
\url{stevenmwise@gmail.com} \ $\diamond$ \  \url{https://scholar.google.com/citations?user=dGv7Ou8AAAAJ}
	\\
...
Preprint at \url{https://arxiv.org/abs/2209.13690}
	...
	\item
M.~Punke, \textbf{S.M. Wise}, A.~Voigt, and M.~Salvalaglio, {\sl Improved Time Integration for Phase-Field Crystal Models of Solidification}, Proc.~Appl.~Math.~Mech.~(in review).
	\\
Preprint at \url{https://arxiv.org/abs/2210.04329}

	\item
Shibin Dai, Joseph Renzi, and \textbf{Steven M. Wise}, {\sl Gamma Convergence of the DeGennes-Cahn-Hilliard Energy}, Comm.~Math.~Sci.~(in review). 
	\\
