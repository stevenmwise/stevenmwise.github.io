...
Preprint at \url{https://arxiv.org/abs/2401.16316}
	...
	\item
M.~Punke, M.~Salvalaglio, and A.~Voigt, and \textbf{S.M. Wise}, {\sl A Non-Isothermal Phase-Field Crystal Model with Lattice Expansion: Analysis and Benchmarks}, Model.~Simul.~Mater.~Sci.~Eng.~(in press)
	\\
...
2019 SIAM-SEAS Conference, with C.~Webster (UTK, Lead), G.~Zhang (ORNL), September 20, 21, 22, 2019, Knoxville, TN.
	\item
2024 SIAM-SEAS Conference, with V.~Maroulas (UTK, Lead), G.~Zhang (ORNL), March 2024, Knoxville, TN.
	\end{description}
    \end{description}
    \end{description}
