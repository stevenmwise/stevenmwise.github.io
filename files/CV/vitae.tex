...
\url{https://doi.org/10.1017/9781108942607}
    \item
A.J.~Salgado, \textbf{S.M.~Wise}, and Calvin Wong, {\sl Multigrid Methods: Axiomatic Convergence Theory for Linear and Weakly Nonlinear Problems}, De Gruyter (in production), approx.~550 pages.
	\item
T.~Luong, T.~Mengesha and \textbf{S.M.~Wise}, {\sl Asymptotic Analysis and Perturbation Theory: Matched Asymptotic, Multiple Scale, and Homogenization Methods}, De Gruyter (under contract, 50\% complete), approx.~400 pages.
    \end{enumerate}
